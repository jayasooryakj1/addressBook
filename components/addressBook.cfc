<cfcomponent>
    ...
    <cffunction  name="displayContacts" returnType="query">
        <cfquery name="contacts">
            select photo, fname, lname, email, phoneNumber, contactId from contacts where _createdBy='#session.user#'
        </cfquery>
        <cfreturn "#contacts#">
    </cffunction>
    ...
    <cffunction  name="deleteFunction" access="remote" returntype="any">
        ...
        <cfquery name="dltQuery">
            delete from contacts where contactId = '#arguments.dlt#'
        </cfquery>
        <cfreturn true>
    </cffunction>
    ...
    <cffunction  name="checkPic" returntype="query">
        ...
        <cfquery name="pic">
            select photo from contacts where userId='#arguments.userid#'
        </cfquery>
        <cfreturn pic.photo>
    </cffunction>
    ...
    <cffunction  name="viewContact" returntype="struct" access="remote" returnFormat="JSON">
        ...
        <cfquery name="viewContact">
            select title, fname, lname, gender, dob, photo, address, street, district, state, country, pincode, email, phoneNumber from contacts where contactId='#arguments.viewId#'
        </cfquery>
    ...
    <cffunction  name="editContact" returntype="struct" access="remote" returnFormat="JSON">
        ...
        <cfquery name="editContact">
            select contactId, title, fname, lname, gender, dob, photo, address, street, district, state, country, pincode, email, phoneNumber from contacts where contactId='#arguments.editId#'
        </cfquery>
